...
const SupplierDeleteDialog = ({ supplier, isOpen, onClose, onConfirm }) => {
      ...
      <DialogContent className="max-w-md">
        ...
        <div className="py-4">
          <p className="text-sm text-gray-700 dark:text-gray-300">
            Are you sure you want to delete <strong>{supplier.companyName}</strong>? This will
...
SupplierDeleteDialog.propTypes = {
