...
/**
 * AttributeHeader displays page title and add button
 */
const AttributeHeader = ({ onAddClick }) => (
  <header className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
    ...
    <Button onClick={onAddClick} className="flex items-center gap-2 self-start sm:self-auto">
      ...
      <span>{UI_TEXT.BTN_ADD_ATTRIBUTE}</span>
    </Button>
  </header>
);
...
export default memo(AttributeHeader);
