export const UI_TEXT = {
  ...
  RECEIVE_DESCRIPTION: 'Are you sure you want to mark this purchase order as received? You cannot modify or delete this and will update the inventory stock levels for all items in this order.',
  TOAST_CREATE: 'Purchase order created successfully',
  TOAST_UPDATE: 'Purchase order updated successfully',
