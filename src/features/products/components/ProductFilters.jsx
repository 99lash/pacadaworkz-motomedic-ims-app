  ...
  <section className="bg-white border border-border rounded-lg shadow-sm p-4 space-y-5 dark:bg-gray-950 dark:border-gray-800">
    ...
    <div className="flex flex-col gap-4 lg:flex-row lg:items-end">
      <div className="w-full lg:max-w-md">
        <label htmlFor="product-search" className="text-sm font-medium text-muted-foreground dark:text-gray-300">
        ...
        <div className="relative mt-1">
          ...
          <Input
            ...
            className="pl-9 h-10 dark:bg-gray-900 dark:text-gray-100 dark:border-gray-800"
          />
        </div>
      </div>
      ...
      <div className="grid w-full gap-4 sm:grid-cols-2 lg:flex lg:flex-1 lg:flex-wrap">
        <div className="flex flex-1 min-w-[160px] flex-col gap-1.5">
          <label htmlFor="product-category-filter" className="text-sm font-medium text-muted-foreground dark:text-gray-300">
        ...
        <div className="flex flex-1 min-w-[160px] flex-col gap-1.5">
          <label htmlFor="product-brand-filter" className="text-sm font-medium text-muted-foreground dark:text-gray-300">
            {UI_TEXT.LABEL_BRAND}
          </label>
          <select
