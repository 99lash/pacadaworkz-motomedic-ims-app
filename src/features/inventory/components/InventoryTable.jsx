      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-gray-50 dark:bg-gray-900/50">
            ...
            <TableHead className="text-gray-700 dark:text-gray-300">{UI_TEXT.COLUMN_CATEGORY}</TableHead>
            <TableHead className="text-gray-700 dark:text-gray-300">{UI_TEXT.COLUMN_BRAND}</TableHead>
            <TableHead className="text-gray-700 dark:text-gray-300">{UI_TEXT.COLUMN_STATUS}</TableHead>
            <TableHead className="text-gray-700 dark:text-gray-300">{UI_TEXT.COLUMN_LAST_STOCK_IN}</TableHead>
          ...
          {inventory.map((item) => {
            ...
            return (
              ...
              >
                ...
                <TableCell className="text-gray-600 dark:text-gray-400">{item.brand}</TableCell>
                <TableCell>
